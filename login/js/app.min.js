...
function eCDSMenuOpen(id) {
    $('#ecdsitem-' + id + ' ul').slideToggle();
    $('#ecdsitem-' + id).toggleClass('active');
}

// const coursescontent = document.querySelectorAll(".coursecontent");
...
function eCDSMenu(id) {
    $('#ecdsmenu-' + id + ' ul').slideToggle();
    $('#ecdsmenu-' + id).toggleClass('active');
}
function clicked() {
    var element = document.getElementsByClassName("search");
